...
import tamimImage from "@/public/images/tamimhasan.webp";
import Image from "next/image";
import analytics from "@/public/svg/ga.svg";
      ...
      <div className="flex flex-col lg:flex-row gap-8 items-center max-w-7xl mx-auto pb-12">
        ...
        <div className="flex-1">
          ...
          <div className="flex gap-3 h-12">
            ...
            <Link
              href="/resume"
              className="bg-gray-700 text-white font-semibold rounded px-4 py-2 flex gap-2 items-center cursor-pointer"
            >
              <svg
                className="w-3"
                aria-hidden="true"
